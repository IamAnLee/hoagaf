...
<?php
    ...
    class order {
        ...
        public function show_order(){
            $id = Session ::get('id');
            $query = "SELECT tbl_offline_payment.*,tbl_custumer.* FROM tbl_offline_payment INNER JOIN tbl_custumer ON tbl_offline_payment.cus_id = tbl_custumer.id";
            $result = $this->db->select($query);
            return $result;
        }
        public function count_order(){
            $query = "SELECT * FROM tbl_offline_payment ";
            $result = $this->db->select($query);
            return $result;
        }
